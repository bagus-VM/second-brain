...
## One-line Summary
Simple contagion spreads through a single contact with an active neighbour, making weak ties and bridges accelerators of global spread.

## Core Intuition
A node becomes infected or informed through any single contact with an active neighbour — no social reinforcement needed. This is how diseases and rumors work: one exposure is enough. Because only one contact is required, weak ties and bridges that connect different communities carry the process to otherwise unreachable parts of the network, accelerating global spread.

## Formal Definition / Statement
A contagion is **simple** if the probability of transmission per contact is independent of how many other active neighbours exist. In network terms: each edge from an active to an inactive node carries independent transmission probability β per time step.
...
1. Single exposure suffices — no threshold beyond one active neighbour
...
- Assuming simple contagion always leads to global spread — vaccination, immunity, and behaviour change can create effective barriers
...
- Opposite behaviour to [[complex-contagion]] — same structures have opposite effects
