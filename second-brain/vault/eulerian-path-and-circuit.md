...
## One-line Summary
An Eulerian path traverses every edge exactly once; an Eulerian circuit does so while returning to the start — existence depends purely on vertex degrees.
